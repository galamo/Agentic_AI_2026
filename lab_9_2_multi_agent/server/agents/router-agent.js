...
const ROUTER_SYSTEM_PROMPT = `You are a router. You have exactly two tools. Use exactly one to answer the user's question.
...
function createRouterTools() {
  ...
  const tools = [answerWithHtmlRagTool, runSqlAgentTool];
